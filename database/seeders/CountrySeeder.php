...
class CountrySeeder extends Seeder
{
    ...
    public function run(): void
    {
        $countries = [
            ...
            ['country_code' => 'AU', 'country_name' => 'Australia', 'currency_name' => 'Dollar', 'currency_code' => 'AUD', 'currency_sign' => '$', 'call' => 'Australians', 'order' => 21],
            ...
            ['country_code' => 'BR', 'country_name' => 'Brazil', 'currency_name' => 'Real', 'currency_code' => 'BRL', 'currency_sign' => 'R$', 'call' => 'Brazilians', 'order' => 15],
            ['country_code' => 'WW', 'country_name' => 'MAIN_WORLDWIDE', 'currency_name' => 'MAIN_BITCOIN', 'currency_code' => 'BTC', 'currency_sign' => 'Ƀ', 'call' => '', 'order' => 16],
            ...
            ['country_code' => 'CA', 'country_name' => 'Canada', 'currency_name' => 'Dollar', 'currency_code' => 'CAD', 'currency_sign' => '$', 'call' => 'Canadians', 'order' => 40],
            ...
            ['country_code' => 'CN', 'country_name' => 'China', 'currency_name' => 'Yuan', 'currency_code' => 'CNY', 'currency_sign' => '¥', 'call' => 'Chinese', 'order' => 23],
            ...
            ['country_code' => 'CZ', 'country_name' => 'Czech Republic', 'currency_name' => 'Koruna', 'currency_code' => 'CZK', 'currency_sign' => 'Kč', 'call' => 'Czechs', 'order' => 24],
            ['country_code' => 'DK', 'country_name' => 'Denmark', 'currency_name' => 'Krone', 'currency_code' => 'DKK', 'currency_sign' => 'kr', 'call' => 'Danes', 'order' => 22],
            ...
            ['country_code' => 'IN', 'country_name' => 'India', 'currency_name' => 'Rupee', 'currency_code' => 'INR', 'currency_sign' => '₹', 'call' => 'Indians', 'order' => 39],
            ...
            ['country_code' => 'JP', 'country_name' => 'Japan', 'currency_name' => 'Yen', 'currency_code' => 'JPY', 'currency_sign' => '¥', 'call' => 'Japanese', 'order' => 19],
            ...
            ['country_code' => 'KR', 'country_name' => 'South Korea', 'currency_name' => 'Won', 'currency_code' => 'KRW', 'currency_sign' => '₩', 'call' => 'Koreans', 'order' => 31],
            ['country_code' => 'KP', 'country_name' => 'North Korea', 'currency_name' => 'Won', 'currency_code' => 'KPW', 'currency_sign' => '₩', 'call' => 'North Koreans'],
            ['country_code' => 'KW', 'country_name' => 'Kuwait', 'currency_name' => 'Dinar', 'currency_code' => 'KWD', 'currency_sign' => 'د.ك', 'call' => 'Kuwaitis', 'order' => 38],
            ...
            ['country_code' => 'LI', 'country_name' => 'Liechtenstein', 'currency_name' => 'Swiss Franc', 'currency_code' => 'CHF', 'currency_sign' => 'CHF', 'call' => '', 'order' => 26],
            ...
            ['country_code' => 'MY', 'country_name' => 'Malaysia', 'currency_name' => 'Ringgit', 'currency_code' => 'MYR', 'currency_sign' => 'RM', 'call' => 'Malaysians', 'order' => 37],
            ...
            ['country_code' => 'MX', 'country_name' => 'Mexico', 'currency_name' => 'Peso', 'currency_code' => 'MXN', 'currency_sign' => '$', 'call' => 'Mexicans', 'order' => 36],
            ...
            ['country_code' => 'NZ', 'country_name' => 'New Zealand', 'currency_name' => 'Dollar', 'currency_code' => 'NZD', 'currency_sign' => '$', 'call' => 'New Zealanders', 'order' => 35],
            ...
            ['country_code' => 'NO', 'country_name' => 'Norway', 'currency_name' => 'Krone', 'currency_code' => 'NOK', 'currency_sign' => 'kr', 'call' => 'Norwegians', 'order' => 34],
            ...
            ['country_code' => 'PL', 'country_name' => 'Poland', 'currency_name' => 'Zloty', 'currency_code' => 'PLN', 'currency_sign' => 'zł', 'call' => 'Poles', 'order' => 33],
            ...
            ['country_code' => 'RU', 'country_name' => 'Russia', 'currency_name' => 'Ruble', 'currency_code' => 'RUB', 'currency_sign' => '₽', 'call' => 'Russians', 'order' => 18],
            ...
            ['country_code' => 'SA', 'country_name' => 'Saudi Arabia', 'currency_name' => 'Riyal', 'currency_code' => 'SAR', 'currency_sign' => 'ر.س', 'call' => 'Saudis', 'order' => 25],
            ...
            ['country_code' => 'SG', 'country_name' => 'Singapore', 'currency_name' => 'Dollar', 'currency_code' => 'SGD', 'currency_sign' => '$', 'call' => 'Singaporeans', 'order' => 17],
            ...
            ['country_code' => 'ZA', 'country_name' => 'South Africa', 'currency_name' => 'Rand', 'currency_code' => 'ZAR', 'currency_sign' => 'R', 'call' => 'South Africans', 'order' => 32],
            ...
            ['country_code' => 'SE', 'country_name' => 'Sweden', 'currency_name' => 'Krona', 'currency_code' => 'SEK', 'currency_sign' => 'kr', 'call' => 'Swedes', 'order' => 30],
            ...
            ['country_code' => 'TW', 'country_name' => 'Taiwan', 'currency_name' => 'New Taiwan Dollar', 'currency_code' => 'TWD', 'currency_sign' => 'NT$', 'call' => '', 'order' => 30],
            ...
            ['country_code' => 'TH', 'country_name' => 'Thailand', 'currency_name' => 'Baht', 'currency_code' => 'THB', 'currency_sign' => '฿', 'call' => 'Thais', 'order' => 30],
            ...
            ['country_code' => 'TR', 'country_name' => 'Turkey', 'currency_name' => 'Lira', 'currency_code' => 'TRY', 'currency_sign' => '₺', 'call' => 'Turks', 'order' => 30],
            ...
            ['country_code' => 'AE', 'country_name' => 'United Arab Emirates', 'currency_name' => 'Dirham', 'currency_code' => 'AED', 'currency_sign' => 'د.إ', 'call' => 'Emiratis', 'order' => 16],
            ['country_code' => 'GB', 'country_name' => 'United Kingdom', 'currency_name' => 'Pound Sterling', 'currency_code' => 'GBP', 'currency_sign' => '£', 'call' => 'British', 'order' => 27],
            ['country_code' => 'US', 'country_name' => 'United States', 'currency_name' => 'Dollar', 'currency_code' => 'USD', 'currency_sign' => '$', 'call' => 'US', 'order' => 29],
            ...
            ['country_code' => 'EU', 'country_name' => 'Euro', 'currency_name' => 'Euro', 'currency_code' => 'EUR', 'currency_sign' => '€', 'call' => '', 'order' => 28],
